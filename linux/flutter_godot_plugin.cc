#include "include/flutter_godot/flutter_godot_plugin.h"
...
#include "flutter_godot_plugin_private.h"

#define FLUTTER_GODOT_PLUGIN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), flutter_godot_plugin_get_type(), \
                              FlutterGodotPlugin))
...
G_DEFINE_TYPE(FlutterGodotPlugin, flutter_godot_plugin, g_object_get_type())

// Called when a method call is received from Flutter.
static void flutter_godot_plugin_handle_method_call(
    FlutterGodotPlugin* self,
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
  ...
  flutter_godot_plugin_handle_method_call(plugin, method_call);
}

void flutter_godot_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  FlutterGodotPlugin* plugin = FLUTTER_GODOT_PLUGIN(
