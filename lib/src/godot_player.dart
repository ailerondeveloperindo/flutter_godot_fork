...
final class GodotPlayer extends StatelessWidget {
  const GodotPlayer({super.key, this.name, this.package, required this.compositionMode});
  ...
  AndroidView _buildTextureAndroidView() {
    return AndroidView(
      viewType: _viewType,
  ...
  PlatformViewLink _buildHybirdPlatformView() {
